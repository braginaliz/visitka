  ...
  const projects = [
    {
      ...
      longDescription:
        "Fullstack проект интернет-магазина бургеров с конструктором заказов, системой авторизации и лентой заказов в реальном времени. Приложение использует React, Redux, TypeScript и WebSocket для обновления заказов.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "Полноценное веб-приложение с авторизацией, загрузкой фотографий, лайками и комментариями. Проект включает валидацию форм, интеграцию с REST API и деплой на сервер.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "Адаптивный одностраничный сайт для аукционного дома с использованием современных технологий верстки. Проект включает сложные анимации и параллакс эффекты.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "MVP архитектура интернет-магазина с каталогом товаров, корзиной и оформлением заказа. Проект реализован с использованием TypeScript и паттерна MVC.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "Fullstack приложение для обмена навыками между пользователями с системой заявок, чатом и WebSocket уведомлениями. Бэкенд на NestJS с PostgreSQL, фронтенд на React.",
      features: [
    ...
    },
    {
      ...
      longDescription:
        "Кроссплатформенное приложение на React Native для планирования маршрутов, бронирования отелей и отслеживания расходов в путешествиях.",
      features: [
  ...
  return (
    <section id="projects" className="projects-section">
      ...
      <div className="content-wrapper">
        ...
        >
          От идеи до реализации — каждый проект это история решения реальных
          задач
        </motion.p>
